...
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000330u)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000338u)
...
uint8 CYXDATA * const CYCODE CapSense_AMuxCH0__addrTable[5] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE CapSense_AMuxCH0__maskTable[5] = {
	0x20u, 
	0x40u, 
	0x80u, 
	0x01u, 
